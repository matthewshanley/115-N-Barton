...
const CASH_FLOWS = [
  ...
  { week:"Mid May",   date:"May 20",   label:"LP equity wires (tranche 1)",  inflow:TRANCHE_1,       outflow:0,               category:"equity",     notes:`$700k capital call — Co-GPs and/or LPs wire by May 20 to fund 109 Barton close. Part of remaining $${(REMAINING_RAISE/1000).toFixed(0)}k LP raise.`},
  { week:"Late May",  date:"May 26",   label:"109 Barton close",             inflow:0,               outflow:TRANCHE_1,       category:"land",       notes:`$680k purchase price less $25k hard deposit in escrow + ~$14k closing costs = $669k due at close. Funded by Tranche 1 capital call.`},
  { week:"May 12",    date:"May 12",   label:"Entitlements hearing",         inflow:0,               outflow:0,               category:"",           notes:"Zoning/entitlements hearing. Approval clears path to permit submission and 109 Barton close."},
